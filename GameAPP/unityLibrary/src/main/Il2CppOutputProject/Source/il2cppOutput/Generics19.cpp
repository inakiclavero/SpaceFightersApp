...
{
	{
		...
		memset((&L_1), 0, sizeof(L_1));
		Enumerator__ctor_m9FD0E513147202D64E1E63556C7AF656522787C5((&L_1), (Dictionary_2_t8C6CF78D944AC75499BAACC0B137BD676FB01911 *)L_0, /*hidden argument*/IL2CPP_RGCTX_METHOD_INFO(method->klass->rgctx_data, 1));
		Enumerator_t7E92857E155F9498ED39340765DDA2DCDB447988  L_2 = (Enumerator_t7E92857E155F9498ED39340765DDA2DCDB447988 )L_1;
...
IL_00dd:
		{
			...
			NetworkBroadcastResult_tA8C2D016C43DA74737F7FF891F288C4CDB774683  L_42 = (NetworkBroadcastResult_tA8C2D016C43DA74737F7FF891F288C4CDB774683 )L_41;
...
{
	{
		...
		memset((&L_1), 0, sizeof(L_1));
		Enumerator__ctor_m115872292179C5612A558211DF708E74AF36D010((&L_1), (Dictionary_2_tBDB65AB25BDC951CC13D7797B156DEBB9C1575E5 *)L_0, /*hidden argument*/IL2CPP_RGCTX_METHOD_INFO(method->klass->rgctx_data, 1));
		Enumerator_t0A358E581F80E5EA21F4AD29A2645B660670B0AF  L_2 = (Enumerator_t0A358E581F80E5EA21F4AD29A2645B660670B0AF )L_1;
		RuntimeObject * L_3 = Box(IL2CPP_RGCTX_DATA(method->klass->rgctx_data, 0), &L_2);
		return (RuntimeObject*)L_3;
	}
}
